...
class bert(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Experiments in BERT")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Experiments in BERT")
        ...
        self.settings = Qt.QSettings("GNU Radio", "bert")
...
def main(top_block_cls=bert, options=None):
